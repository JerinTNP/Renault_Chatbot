...
def detect_quality_assessment_results(dealer_qa, questions_partial,config):
    ...
    """
    questions, question_numbers, question_indices, multi_line_indices = detect_questions_detailed(dealer_qa, questions_partial,config)
 
    answer_indices = get_answer_idices(question_indices, multi_line_indices)
 
    status, answers, pre_comment, post_comment = detect_answers(dealer_qa, answer_indices)
